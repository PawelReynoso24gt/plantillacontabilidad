  ...
  <div class="page-wrapper">
    <div class="page-card">
      ...
      <div class="module-header">
        <div>
          <h2 class="module-title">Libro Mayor - Capilla</h2>
      ...
      <div v-if="ingresosEgresos.length" class="encabezado-container">
        <div class="encabezado-box">
          <div class="encabezado-titulo">PROYECTO CAPILLA HOGAR SANTA LUISA</div>
      ...
      <!-- Mensajes de estado -->
      <div v-if="loading" class="table-empty mt-3">Cargando movimientos...</div>
      <div v-else-if="error" class="table-empty mt-3" style="color: var(--color-danger);">
        Ocurrió un error al cargar los movimientos.
      </div>
      <div v-else-if="!tablaFormateada.length" class="table-empty mt-3">
