  ...
  <div class="error-wrapper">
    <div class="error-card">
      ...
      <p class="error-message">
        El servidor no pudo procesar los datos enviados. Esto normalmente ocurre cuando hay campos incompletos o información que no cumple con el formato requerido.
      </p>
...
<style scoped>
/* =========================================
   RESET BÁSICO (Aplicado solo a este componente gracias a 'scoped')
========================================= */
* {
  margin: 0;
  padding: 0;
