  ...
  <div class="page-wrapper">
    <div class="page-card">
      ...
      <div class="module-header">
        <div>
          <h2 class="module-title">Registro de Ingreso Agrícola</h2>
      ...
      <div class="section-container section-container--block mt-4">
        <h3 class="section-title">Cuentas Pendientes por Cobrar</h3>
...
export default {
  ...
  setup() {
    ...
    const success = ref(''); // Mensaje de éxito para acciones sobre el listado (ej. eliminar)
